 ...
 */
sensor_msgs::Image disparityToROS(const mrpt::img::CImage& img, const std_msgs::Header& msg_header)
{
...
{
  left = mrpt::ros1bridge::toROS(obj.imageLeft, msg_header);
  right = mrpt::ros1bridge::toROS(obj.imageRight, msg_header);
