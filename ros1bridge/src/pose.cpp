...
geometry_msgs::PoseWithCovariance mrpt::ros1bridge::toROS_Pose(
...
geometry_msgs::PoseWithCovariance mrpt::ros1bridge::toROS(
...
mrpt::poses::CPose3DPDFGaussian mrpt::ros1bridge::fromROS(
